<!DOCTYPE html>
<html lang="en">
  <head><title>My Stuffs Online</title></head>
    <meta charset="utf-8">
    ...
    <!--[if lt IE 9]>
      <script src="files/docs/assets/js/html5shiv.js"></script>
    <![endif]-->

    <!-- Fav and touch icons -->
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="files/docs/assets/ico/apple-touch-icon-144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="files/docs/assets/ico/apple-touch-icon-114-precomposed.png">
      ...
      <div class="container">
        ...
        <div class="navbar navbar-inverse">
          <div class="navbar-inner">
            ...
            <a class="brand" href="index.jsp">My Stuffs Online</a>
