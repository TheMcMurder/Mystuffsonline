<hr class="featurette-divider">
      ...
      <footer>
        ...
        <p>&copy; 2013 Myer Photography, Inc. &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
      </footer>
...
<!--     <script src="files/docs/assets/js/bootstrap-dropdown.js"></script>
 -->    <script src="files/docs/assets/js/bootstrap-scrollspy.js"></script>
    ...
    <script src="files/docs/assets/js/bootstrap-button.js"></script>
...
<!-- 	<script type="text/javascript" src="http://twitter.github.com/bootstrap/assets/js/bootstrap-dropdown.js"></script>
 -->	
    ...
    <script src="files/docs/assets/js/holder/holder.js"></script>
  </body>
</html>